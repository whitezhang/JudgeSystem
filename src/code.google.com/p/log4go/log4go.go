...
import (
	"classified-lib/golang-lib/module_state2"
)
...
// set noah prefix key
func SetNoahKeyPrefix(key string) {
	log4goState.SetNoahKeyPrefix(key)
}

// get noah prefix key
func GetNoahKeyPrefix() string {
	return log4goState.GetNoahKeyPrefix()
}
